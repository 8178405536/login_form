...
<?php
$query2=mysqli_query($con,"select id from users where date(posting_date)>=now()");
$last7daysregusers=mysqli_num_rows($query2);
?>

                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-info text-white text-white mb-4">
                                    <div class="card-body"> Add Image in  Cart page
...
?>
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-dark text-white mb-4">
                                    <div class="card-body">  Confirm Deatil
                                        <span style="font-size:22px;"> </span></div>
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small text-white stretched-link" href="orderconfirm.php">View Details</a>
                                        <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                                    </div>
                                </div>
                            </div>
