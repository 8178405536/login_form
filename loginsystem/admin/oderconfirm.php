...
<html lang="en">
    <head>
        ...
        <title>Registered Users in Last 30 Days |   show the  details All  Order</title>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4"> Show  The Details All Order </h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="dashboard.php">Dashboard</a></li>
                            <li class="breadcrumb-item active">Show  The Details All Order </li>
                        </ol>
            
                        <div class="card mb-4">
                            <div class="card-header">
                                <i class="fas fa-table me-1"></i>
                                Show  The Details All Orders
                            </div>
                            <div class="card-body">
